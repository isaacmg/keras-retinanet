...
def create_models(backbone_retinanet, backbone, num_classes, weights, multi_gpu=0, freeze_backbone=False, learning_rate=1e-5, regularization=0):
    ...
    training_model.compile(
        ...
        optimizer=keras.optimizers.adam(lr=float(learning_rate), clipnorm=0.001)
    )
...
def parse_args(args):
    ...
    parser.add_argument('--regularization', help='Value for regularization', default=0)
    parser.add_argument('--regularization-type', help='Type of regularization defaults to l2', default="l2")
    parser.add_argument('--backbone-weight', help='URL to the weights of the Backbone model used by retinanet.')
